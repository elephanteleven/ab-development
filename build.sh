...
for ab_service in web db migration_manager api_sails appbuilder custom_reports definition_manager file_processor llm_interface log_manager notification_email process_manager relay tenant_manager user_manager;
do
   (
