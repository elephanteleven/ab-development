...
for ab_service in web db migration_manager api_sails appbuilder custom_reports definition_manager file_processor log_manager notification_email process_manager tenant_manager user_manager;
do
   (
